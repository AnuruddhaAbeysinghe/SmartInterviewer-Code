...
def getDifficultyList(userid,languageName,difficultyLevel):
    exist = "MATCH(n: user_difficulty{uid: '" + userid + "'}) - [r: level]->(b:difficulty{technology: '" + languageName + "'}) return b." + difficultyLevel + ""
    qtableValue = graph.run(exist).evaluate()
    return qtableValue
